...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_3OWVYTQQ2Xo9ese4BWEtpiPiha6MKejnDoTxXUHGJANI337qKoXrkuvtGOdIgZwF";
...
breedSelect.addEventListener("change", (event)=>{
    ...
    if (selectedBreedId) showCatInfo(selectedBreedId);
    else catInfo.innerHTML = "";
});
function showCatInfo(breedId) {
    loader.style.display = "block";
    error.style.display = "none";
    (0, _catApiJs.requestServer)(breedId).then((data)=>{
...
},{"axios":"jo6P5","./cat-api.js":"d7YdZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d7YdZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchBreeds", ()=>fetchBreeds);
parcelHelpers.export(exports, "requestServer", ()=>requestServer);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const BASE_URL = "https://api.thecatapi.com/v1";
function fetchBreeds() {
    return (0, _axiosDefault.default).get(`${BASE_URL}/breeds`).then((response)=>response.data).catch((error)=>{
        console.error(error);
    });
}
function requestServer(breedId) {
    return (0, _axiosDefault.default).get(`${BASE_URL}/images/search?breed_ids=${breedId}`).then((response)=>response.data).catch((error)=>{
        console.error(error);
    });
}
